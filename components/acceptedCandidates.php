                        ...
                        <table class="table datatables" id="dataTable-1">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $user_details['FIRSTNAME']  .$user_details['MIDDLENAME'] .$user_details['LASTNAME']; ?></td>
                                      ...
                                      <?php
                                        if ($row['ACCEPTED']) {
                                          ...
                                          echo"
                                            ...
                                            <a class='btn btn-danger' href='../Logic/deleteList.php?listId=".$row['ID']."'>Reject</a>
                                          ";
                                        }
                                      ?>
                                    </td>
