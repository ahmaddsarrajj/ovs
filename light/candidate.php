<?php
  ...
  $get_nom_request_sql = "
    SELECT * FROM  nomrequest 
  ";
  $get_nom_request = mysqli_query($conn, $get_nom_request_sql);
  ...
  <div class="wrapper">
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <?php include '../components/tableCandidate.php'; ?>
          <br><br>
          <?php 
          
          mysqli_data_seek($get_nom_request, 0);
          include '../components/acceptedCandidates.php'; ?>
</div>
</main>
