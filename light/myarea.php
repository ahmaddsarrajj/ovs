                        ...
                        <div class="card shadow">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                  // location
                              $get_location_query = "SELECT smallarea.NAME AS small_area_name, bigarea.NAME AS big_area_name, record.NAME AS record_name, bigarea.ID AS bigareaid
                              FROM user
                              ...
                              $location = mysqli_fetch_assoc($get_location);
                                    if ($row['ROLEID'] != 2 && $location['bigareaid'] == $user['BIGAREAID']){
                                    echo "
                                    <tr>
